# RESUME.md history — hand-offs moved out when RESUME.md was bounded

RESUME.md is the per-wake hand-off, capped at the milestone's `resume-lines`
(roadmap 393.8). What it used to accumulate — dated hand-offs, plans, cloud-wake
reports, carried-forward notes — lives here, verbatim and never edited, in the
order it was moved. Nothing here is read at Step 0; cite it by date and slice.

## Moved 2026-09-26 by 393.8 — RESUME.md lines 24-1044 at `7a852da6`, verbatim
...
M0 wakes used: 7 / 12 (393.1-393.7 landed; 392.4 and 381.2 closed inside
393.5; holds are counted separately as `hold-wakes`, and 1 is recorded).
Next: 393.8 (RESUME.md bounded), then 393.9 (apply the realignment table)
and 393.10 (re-score the loop), in `After:` order.
