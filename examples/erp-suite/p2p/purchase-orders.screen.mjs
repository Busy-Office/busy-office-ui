...
const rows = [
  ['PO-88213', 'Northwind Supply', 'CC-4021', '2026-08-28', '48,200.00', 'Pending approval', 'warning'],
  ['PO-88198', 'Ferrus Metals', 'CC-4021', '2026-08-25', '12,940.00', 'Approved', 'success'],
  ['PO-88164', 'Kite Logistics', 'CC-1180', '2026-08-24', '3,180.50', 'Approved', 'success'],
  ['PO-88140', 'Northwind Supply', 'CC-2205', '2026-08-21', '27,015.00', 'Partially received', ''],
  ['PO-88121', 'Aalto Plastics', 'CC-1180', '2026-08-19', '9,600.00', 'Closed', ''],
  ['PO-88097', 'Ferrus Metals', 'CC-4021', '2026-08-18', '61,750.00', 'Rejected', 'danger'],
];
    ...
    <div class="bo-data-table-container" tabindex="0" data-density="compact">
      ...
      <table class="bo-data-table bo-data-table--sticky-col">
        ...
        <tbody>
          ${rows
            .map(
              ([no, vendor, cc, due, amount, status, tone]) => `<tr>
