...
<!-- stat:size -->94 kB minified (15.2 kB gzipped)<!-- /stat --> for the whole
...
the build runs <!-- stat:gates -->56 build gates, 23 of them heuristic detectors that each ship a `--self-test`<!-- /stat -->.
