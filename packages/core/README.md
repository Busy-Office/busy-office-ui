...
<!-- stat:size -->97 kB minified (15.9 kB gzipped)<!-- /stat --> for the whole
...
the build runs <!-- stat:gates -->57 build gates, 24 of them heuristic detectors that each ship a `--self-test`<!-- /stat -->.
