...
<!-- stat:size -->98 kB minified (16.0 kB gzipped)<!-- /stat --> for the whole
...
the build runs <!-- stat:gates -->58 build gates, 25 of them heuristic detectors that each ship a `--self-test`<!-- /stat -->.
